...
class ScantelligentGUI:
    ...
    def make_buttons(self) -> dict:
        ...
        buttons = {
            ...
            "tip": make_button("Tip", "Tip status\n(Ctrl + Space to toggle feedback)"),
            ...
            "default_parameters_0": make_button("0", "Load default parameter set 0"),
            "default_parameters_1": make_button("1", "Load default parameter set 1"),
            "default_parameters_2": make_button("2", "Load default parameter set 2"),
            ...
            "save": make_button("", "Save the experiment results to file"),
